...
function WARE:Initialize()
	...
	GAMEMODE:DrawInstructions( "Поймай белый!" )
...
function WARE:PhaseSignal( iPhase )
	if iPhase == 2 then
		...
		GAMEMODE:DrawInstructions( "Бейте игроков, держащих в руках грави-пушку!" , self.RoleColor , nil , rpAttack )
		GAMEMODE:DrawInstructions( "Не позволяй себя ударить!" , self.RoleColor , nil , rpFlee )
