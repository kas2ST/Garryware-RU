...
function WARE:Initialize()
	...
	GAMEMODE:DrawInstructions( "Смотри за пропами..." )
...
function WARE:StartAction()
	GAMEMODE:DrawInstructions( "Сколько пропов исчезло?" )
...
function WARE:EndAction()
	...
	GAMEMODE:DrawInstructions( "Ответ был ".. self.Answer .."!" , self.CorrectColor)
