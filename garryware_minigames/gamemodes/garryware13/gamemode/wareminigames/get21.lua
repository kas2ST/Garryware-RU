...
function WARE:Initialize()
	...
	GAMEMODE:DrawInstructions( "Получи 21!" )
...
function WARE:EndAction()
	...
	GAMEMODE:PrintInfoMessage( "Возможная комбинация", " была ", message .."!" )
	GAMEMODE:DrawInstructions( "Возможная комбинация была ".. message .."!" , self.CorrectColor)
end
