...
function WARE:Initialize()
	...
	GAMEMODE:DrawInstructions( "Будь полезным!" )
...
function WARE:StartAction()	
	...
	GAMEMODE:DrawInstructions( "Соберите ".. self.ToGather .." файла в папку!" )
...
function WARE:MidActionTrigger()
	...
	GAMEMODE:DrawInstructions( "Отправьте все письма в Facepunch!" )
