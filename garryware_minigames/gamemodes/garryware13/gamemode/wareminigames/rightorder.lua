...
function WARE:Initialize()
	...
	--GAMEMODE:DrawInstructions("Стрельните во все " .. self.NumberSpawns .." ящиков в правильном порядке!" )
	GAMEMODE:DrawInstructions("Стреляйте в правильном порядке!" )
...
function WARE:StartAction()
	...
	if (croissant == 1) then
		...
		GAMEMODE:DrawInstructions( "В порядке возрастания! (1 , 2 , 3...)" )
		GAMEMODE:PrintInfoMessage( "Последовательность порядка", " - ", "возрастание (1 , 2 , 3...)!" )
	else
		for k=self.NumberSpawns,1,-1 do
			table.insert( self.Sequence , k )
		end
		GAMEMODE:DrawInstructions( "В порядке убывания! (3 , 2 , 1...)" )
		GAMEMODE:PrintInfoMessage( "Последовательность порядка", " - ", "убывание (3 , 2 , 1...)!" )
	end
