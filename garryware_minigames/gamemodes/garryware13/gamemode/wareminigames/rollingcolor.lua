...
WARE.PossibleColors = {
	...
	{ "серый" , Color(138,138,138,255)},
	{ "белый" , Color(255,255,255,255)},
...
function WARE:Initialize()
	...
	GAMEMODE:DrawInstructions( "Подожди и стрельни в ".. self.PossibleColors[selected][1] .." проп!" , self.PossibleColors[selected][2] or nil, self.PossibleColors[selected][3] or nil )
