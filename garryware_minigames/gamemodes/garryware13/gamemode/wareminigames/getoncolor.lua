...
WARE.PossibleColors = {
	{ "чёрный" , Color(0,0,0,255) },
	{ "серый" , Color(138,138,138,255), Color(255,255,255,255) },
	{ "белый" , Color(255,255,255,255), Color(0,0,0,255) },
	{ "красный" , Color(220,0,0,255) },
	{ "зелёный" , Color(0,220,0,255) },
	{ "синий" , Color(64,64,255,255) },
	{ "розовый" , Color(255,0,255,255) }
}
...
function WARE:Initialize()
	...
	GAMEMODE:DrawInstructions( "Встань на ".. self.PossibleColors[selected][1] .." круг!" , self.PossibleColors[selected][2] or nil, self.PossibleColors[selected][3] or nil )
...
function WARE:PhaseSignal( iPhase )
	if iPhase <= 3 then
		...
		GAMEMODE:DrawInstructions( "А сейчас встань на ".. self.PossibleColors[selected][1] .." круг!" , self.PossibleColors[selected][2] or nil, self.PossibleColors[selected][3] or nil )
