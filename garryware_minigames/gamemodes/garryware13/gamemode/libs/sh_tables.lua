...
GM.WASND = 
{
	...
	{
		// Ann Sound
		{"Ann1", Sound("ware/countdown_ann_sec11.mp3")},
		{"Ann2", Sound("ware/countdown_ann_sec21.mp3")},
		{"Ann3", Sound("ware/countdown_ann_sec31.mp3")},
		{"Ann4", Sound("ware/countdown_ann_sec41.mp3")},
		{"Ann5", Sound("ware/countdown_ann_sec51.mp3")},
		// Dos Sound
		{"Dos1", Sound("ware/countdown_dos_sec11.mp3")},
		{"Dos2", Sound("ware/countdown_dos_sec21.mp3")},
		{"Dos3", Sound("ware/countdown_dos_sec31.mp3")},
		{"Dos4", Sound("ware/countdown_dos_sec41.mp3")},
		{"Dos5", Sound("ware/countdown_dos_sec51.mp3")}		
	},
	// 7. Tick Sound
	{
