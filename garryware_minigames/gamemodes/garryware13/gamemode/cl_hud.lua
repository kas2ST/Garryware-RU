...
function GM:AddScoreboardStreak( ScoreBoard )
	...
	ScoreBoard:AddColumn( "Лучшая Серия", 80, f, 0.5, nil, 6, 6 )
...
function GM:AddScoreboardAward( ScoreBoard )
	...
	ScoreBoard:AddColumn( "Награды", 190, f, 0.5 , nil, 6 , 6 )
...
function GM:HUDDrawTargetID()
	...
	local text = trace.Entity:Frags() .. " Выиграл"
