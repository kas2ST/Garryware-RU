...
language.Add( "env_laser", "Лазер" )
language.Add( "env_explosion", "Взрыв" )
language.Add( "func_door", "Дверь" )
language.Add( "func_door_rotating", "Дверь" )
language.Add( "trigger_hurt", "Опасность" )
language.Add( "func_rotating", "Опасность" )
language.Add( "worldspawn", "Гравитация" )
language.Add( "prop_physics", "Проп" )
language.Add( "prop_physics_respawnable", "Проп" )
language.Add( "prop_physics_multiplayer", "Проп" )
language.Add( "entityflame", "Огонь" )
